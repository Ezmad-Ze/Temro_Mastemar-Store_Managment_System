...
namespace TemroMastemar.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required(ErrorMessage = "እባክዎ ኢ ሜይል ያስገቡ")]
            [EmailAddress]
            [Display(Name = "ኢ ሜይል አስገቡ")]
            public string Email { get; set; }


            [Required(ErrorMessage = "እባክዎ ማሰሪያ ቁልፍ ያስገቡ")]
            [StringLength(100, ErrorMessage = "{0} ማሰሪያ ቁልፉ ቢያንስ {2} ቢበዛ {1} መሆን አለበት ", MinimumLength = 6)]
            [DataType(DataType.Password)]
            [Display(Name = "ማሰሪያ ቁልፍ")]
            ...
            /// </summary>
            [DataType(DataType.Password)]
            [Display(Name = "ማሰሪያ ቁልፍ አረጋግጥ")]
            [Compare("Password", ErrorMessage = "የላይኛው ማሰሪያ ቁልፍ ከታችኛው ማሰሪያ ቁልፍ ጋር አይገናኙም")]
